...
Table \ref{table:ourevals} captures our evaluation of these methods. We expect these accuracy measures to be lower than they were reported in the original papers because we are using a smaller training dataset and not attempting to optimize the methods.
...
We achieved the best accuracy with the SVM method with HMM smoothing from \citet{poliner2006discriminative}. 
